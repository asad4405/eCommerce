        ...
        <div class="row g-4">
            <div class="col-xl-8 ratio_65">
                <div class="home-contain h-100">
                    <div class="h-100">
                        <img src="{{ asset('frontend_assets') }}/images/vegetable/banner/1.jpg" class="bg-img blur-up lazyload"
                            alt="">
                    </div>
                ...
                <div class="row g-4">
                    <div class="col-xl-12 col-md-6">
                        <div class="home-contain">
                            <img src="{{ asset('frontend_assets') }}/images/vegetable/banner/2.jpg" class="bg-img blur-up lazyload"
                                alt="">
                    ...
                    <div class="col-xl-12 col-md-6">
                        <div class="home-contain">
                            <img src="{{ asset('frontend_assets') }}/images/vegetable/banner/3.jpg" class="bg-img blur-up lazyload"
                                alt="">
                            <div class="home-detail p-center-left home-p-sm w-75">
                                <div>
        ...
        <div class="banner-slider">
            <div>
                <div class="banner-contain hover-effect">
                    <img src="{{ asset('frontend_assets') }}/images/vegetable/banner/4.jpg" class="bg-img blur-up lazyload"
                        alt="">
            ...
            <div>
                <div class="banner-contain hover-effect">
                    <img src="{{ asset('frontend_assets') }}/images/vegetable/banner/5.jpg" class="bg-img blur-up lazyload"
                        alt="">
                    <div class="banner-details">
                        <div class="banner-box">
                            <h6 class="text-danger">5% OFF</h6>
            ...
            <div>
                <div class="banner-contain hover-effect">
                    <img src="{{ asset('frontend_assets') }}/images/vegetable/banner/6.jpg" class="bg-img blur-up lazyload"
                        alt="">
                    <div class="banner-details">
                        <div class="banner-box">
                            <h6 class="text-danger">5% OFF</h6>
            ...
            <div>
                <div class="banner-contain hover-effect">
                    <img src="{{ asset('frontend_assets') }}/images/vegetable/banner/7.jpg" class="bg-img blur-up lazyload"
                        alt="">
                    <div class="banner-details">
                        <div class="banner-box">
                            <h6 class="text-danger">5% OFF</h6>
                ...
                <div class="p-sticky">
                        ...
                        <ul>
                            <li>
                                <div class="category-list">
                                    <img src="{{ asset('frontend_assets') }}/svg/1/vegetable.svg" class="blur-up lazyload"
                                        alt="">
                                    <h5>
                            ...
                            <li>
                                <div class="category-list">
                                    <img src="{{ asset('frontend_assets') }}/svg/1/cup.svg" class="blur-up lazyload" alt="">
                                    <h5>
                            ...
                            <li>
                                <div class="category-list">
                                    <img src="{{ asset('frontend_assets') }}/svg/1/meats.svg" class="blur-up lazyload" alt="">
                                    <h5>
                            ...
                            <li>
                                <div class="category-list">
                                    <img src="{{ asset('frontend_assets') }}/svg/1/breakfast.svg" class="blur-up lazyload"
                                        alt="">
                                    <h5>
                            ...
                            <li>
                                <div class="category-list">
                                    <img src="{{ asset('frontend_assets') }}/svg/1/frozen.svg" class="blur-up lazyload"
                                        alt="">
                                    <h5>
                            ...
                            <li>
                                <div class="category-list">
                                    <img src="{{ asset('frontend_assets') }}/svg/1/biscuit.svg" class="blur-up lazyload"
                                        alt="">
                                    <h5>
                            ...
                            <li>
                                <div class="category-list">
                                    <img src="{{ asset('frontend_assets') }}/svg/1/grocery.svg" class="blur-up lazyload"
                                        alt="">
                                    <h5>
                            ...
                            <li>
                                <div class="category-list">
                                    <img src="{{ asset('frontend_assets') }}/svg/1/drink.svg" class="blur-up lazyload" alt="">
                                    <h5>
                            ...
                            <li>
                                <div class="category-list">
                                    <img src="{{ asset('frontend_assets') }}/svg/1/milk.svg" class="blur-up lazyload" alt="">
                                    <h5>
                            ...
                            <li class="pb-30">
                                <div class="category-list">
                                    <img src="{{ asset('frontend_assets') }}/svg/1/pet.svg" class="blur-up lazyload" alt="">
                                    <h5>
                    ...
                    <div class="ratio_156 section-t-space">
                        <div class="home-contain hover-effect">
                            <img src="{{ asset('frontend_assets') }}/images/vegetable/banner/8.jpg" class="bg-img blur-up lazyload"
                                alt="">
                    ...
                    <div class="ratio_medium section-t-space">
                        <div class="home-contain hover-effect">
                            <img src="{{ asset('frontend_assets') }}/images/vegetable/banner/11.jpg" class="img-fluid blur-up lazyload"
                                alt="">
                            <div class="home-detail p-top-left home-p-medium">
                                <div>
            ...
            <div class="col-xxl-9 col-xl-8">
                ...
                <div class="category-slider-2 product-wrapper no-arrow">
                    ...
                    <div>
                        <a href="shop-left-sidebar.html" class="category-box category-dark">
                            <div>
                                <img src="{{ asset('frontend_assets') }}/svg/1/frozen.svg" class="blur-up lazyload" alt="">
                                <h5>Frozen Foods</h5>
                            </div>
                        </a>
                    </div>
                ...
                <div class="section-t-space">
                    <div class="banner-contain">
                        <img src="{{ asset('frontend_assets') }}/images/vegetable/banner/15.jpg" class="bg-img blur-up lazyload"
                            alt="">
                ...
                <div class="section-t-space">
                    <div class="banner-contain hover-effect">
                        <img src="{{ asset('frontend_assets') }}/images/vegetable/banner/14.jpg" class="bg-img blur-up lazyload"
                            alt="">
