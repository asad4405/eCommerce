                ...
                <div class="col-xxl-4 order-lg-2">
                    <div class="poster-box">
                        <div class="poster-image">
                            <img src="{{ asset('frontend_assets') }}/images/vendor-page/become-saller.svg" class="img-fluid"
                                alt="">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-7">
                    <div class="seller-title h-100 d-flex align-items-center">
                        <div>
                            ...
                            <!-- <div class="saller-button">
                                                        <button class="btn btn-md theme-bg-color text-white">Start Selling</button>
                                                        <button class="btn btn-md btn-animation">Avail Offer</button>
                                                    </div> -->
                        </div>
                    </div>
                </div>
