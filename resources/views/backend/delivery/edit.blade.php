                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-header-2">
                                        <h5>Edit Product Delivery Option</h5>
                                    </div>
                                    ...
                                    <form class="theme-form theme-form-2 mega-form" action="{{ route('delivery.update',$delivery->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('PUT')
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" placeholder="Product Delivery Address"
                                                    name="product_delivery_address" value="{{ $delivery->product_delivery_address }}">
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" placeholder="Product Delivery Cost"
                                                    name="product_delivery_cost" value="{{ $delivery->product_delivery_cost }}">
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <div class="col-sm-9">
                                                <button class="btn theme-bg-color text-white">Update Product Delivery Cost</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
